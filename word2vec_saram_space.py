...
filename = "/home/minhopark2115/vtw/parsed_data/parsed_data"
...
with open(FLAGS.log_dir+"embedding.pkl","w") as f:
  pickle.dump(final_embeddings, f)

with open(FLAGS.log_dir+"data.pkl","w") as f:
  pickle.dump(data, f)

with open(FLAGS.log_dir+"count.pkl","w") as f:
  pickle.dump(count, f)

with open(FLAGS.log_dir+"dictionary.pkl","w") as f:
  pickle.dump(dictionary, f)

with open(FLAGS.log_dir+"reverse_dictionary","w") as f:
